...
const DateSelectField = ({
  ...
  return (
    <div className="mb-4" id={dateSelectWrapperId} data-testid={id}>
      <fieldset>
        <FieldSetLegend id={dateSelectLabelId} required={required} label={label} textRequired={textRequired} />
        {errorMessage && <InputErrorMessage id={dateSelectErrorMessageId} message={errorMessage} />}
        {helpMessage && (
          <div className="mb-1.5 max-w-prose text-base text-gray-600" id={dateSelectHelpMessageId}>
            {helpMessage}
          </div>
        )}
