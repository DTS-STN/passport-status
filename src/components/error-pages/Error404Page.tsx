    ...
    <ErrorLayout>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
        <div lang="en">
          ...
          <p>
            We&#39;re sorry you ended up here. Sometimes a page gets moved or deleted, but hopefully we can help you find what
            you&#39;re looking for. What next?
          </p>
        ...
        <div lang="fr">
          ...
          <p>
            Nous sommes désolés que vous ayez abouti ici. Il arrive parfois qu&#39;une page ait été déplacée ou supprimée.
            Heureusement, nous pouvons vous aider à trouver ce que vous cherchez. Que faire?
          </p>
          <ul className="list-disc space-y-2 pl-10">
            <li>
              Retournez à la{' '}
