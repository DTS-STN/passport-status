...
export const mapToCheckStatusApiResponse = (
  ...
  serviceLevel: getCertificateApplicationResponse.CertificateApplication.CertificateApplicationServiceLevel
    .ServiceLevelCode as ServiceLevelCode,
  deliveryMethod: getCertificateApplicationResponse.CertificateApplication.CertificateApplicationDeliveryMethod
    .DeliveryMethodCode as DeliveryMethodCode,
  manifestNumber: getManifestNumber(
    getCertificateApplicationResponse.CertificateApplication.CertificateApplicationIdentification,
  ),
  status: getCertificateApplicationResponse.CertificateApplication.CertificateApplicationStatus.StatusCode,
  ...
  receivedDate:
    getTimelineDateByDataReference(
      getCertificateApplicationResponse.CertificateApplication.CertificateApplicationTimelineDates,
...
export const getManifestNumber = (
  ...
  return identifications?.find((x) => x.IdentificationCategoryText.toLowerCase() === 'Manifest Number'.toLowerCase())
    ?.IdentificationID;
};
